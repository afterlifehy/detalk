...
class SelectNetWorkActivity : VbBaseActivity<SelectNetworkViewModel, ActivitySelectNetworkBinding>(), OnClickListener {
    ...
    override fun initData() {
        networkList?.add(NetworkBean(com.wx.common.R.mipmap.ic_eth, "Ethereum", AppFlag.ethChainIdMap[BuildConfig.is_dev]!!))
        networkList?.add(NetworkBean(com.wx.common.R.mipmap.ic_bsc, "BNB Chain", AppFlag.bscChainIdMap[BuildConfig.is_dev]!!))
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.ll_network -> {
                ...
                Constant.chainId = network.chainId
