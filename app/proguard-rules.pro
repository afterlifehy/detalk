...
#---------------------------------1.实体类---------------------------------
-keep class com.wx.detalk.bean.**{*;}
-keep class com.wx.detalk.event.**{*;}
-keep class com.wx.base.bean.**{*;}
-keep class com.wx.base.event.**{*;}
-keep class com.wx.common.bean.**{*;}
-keep class com.wx.common.event.**{*;}
#--数据库实体类不被混淆
#-keep class com.wx.detalk.roomdao.**{*;}
#-------------------------------------------------------------------------
...
#---------------------------------自定义view-----------------------
-keep class com.wx.detalk.view.**{*;}
-keep class com.wx.common.view.**{*;}
-keep class com.wx.common.widget.**{*;}
-keep class com.wx.base.view.**{*;}
-keep class com.wx.base.widget.**{*;}
#---------------------------------反射相关的类和方法-----------------------
