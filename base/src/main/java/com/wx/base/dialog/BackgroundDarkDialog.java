...
public class BackgroundDarkDialog extends Dialog {

    private WindowManager mWindowManager;
    private int mScreenWidth, mScreenHeight;
    public int mRightOf, mLeftOf, mBelow, mAbove;
    ...
    //statusBarColor
    private int darkColor = Color.parseColor("#a0000000");

    public BackgroundDarkDialog(Context context) {
        super(context, R.style.alertdialog);
    }

    public BackgroundDarkDialog(Context context, @StyleRes int themeResId) {
    ...
    public void setContentView(View view) {
        ...
        this.rootView = view;
        if (rootView != null) {
            mWindowManager = (WindowManager) rootView.getContext().getSystemService(Context.WINDOW_SERVICE);
//            mDarkView = new View(rootView.getContext());
//            mDarkView.setFitsSystemWindows(true);
//            mDarkView.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.MATCH_PARENT));
//            mDarkView.setBackgroundColor(darkColor);
    ...
    private void invokeBgCover(View view) {
        if (mIsDarkInvoked || isShowing() || rootView == null) {
            return;
        }
        checkPosition();
//        if (mDarkView != null) {
